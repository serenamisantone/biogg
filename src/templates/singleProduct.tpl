                          ...
                          <div class="col-xl-6">
                              <div class="product-info">
                                  ...
                                  <div class="pricing mt-2">
                                      <span class="fw-bold fs-xs ">{$product-> getPrice()}€</span>
                                  ...
                                  {foreach $features as $feature }
                                      <li><span class="me-2 text-primary"><i class="fa-solid fa-circle-check"></i></span>{$feature['title']}</li>
                                  ...
                                  <div class="d-flex align-items-center gap-4 flex-wrap">
                                      <div class="product-qty d-flex align-items-center">
                                          ...
                                          <input type="number" value="1" min="1" max = {$product -> getStock()} data-max = {$product -> getStock()} id="quantity" disabled>
