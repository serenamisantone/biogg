                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4">
                                <div class="product-info">
                                    ...
                                    <a href="shop.php?categoryId={$category->getId()}" style="margin-left: 10px;">{$category->getName()}</a>
                                </div>
                                    <div class="widget-title d-flex mt-4">
    {assign var="manufacturer" value=$singleProduct->getManufacturer()}
    <h6 class="mb-1 flex-shrink-0">Produttore</h6>
    <a href="shop.php?manufacturerId={$manufacturer->getId()}" style="margin-left: 10px;">{$manufacturer->getName()}</a>
</div>
