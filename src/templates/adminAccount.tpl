    ...
    <div class="row g-5">
        ...
        <div class="col-md-9" style="padding-top: 20px; padding-bottom: 20px;">
            <div class="tab-content">
                            ...
                            <tbody>
                                {foreach $data_products as $product}
                                    ...
                                    <tr>
                                        ...
                                        <td>{$product->getDescription()|custom_substr:0:50}...</td>
                                        ...
                                        <td>
                                            <button type="button" data-bs-toggle="modal"
                                                data-bs-target="#editModalProduct_{$product->getId()}">
                                        ...
                                        <td>
                                            <button type="button" onclick="deleteProduct({$product->getId()})">
                ...
                {foreach $data_products as $product}
                    <div class="modal fade" id="editModalProduct_{$product->getId()}" tabindex="-1"
                        aria-labelledby="editModalLabel_{$product->getId()}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="gstore-product-quick-view bg-white rounded-3 py-6 px-4">
                                        ...
                                        <div class="row align-items-center g-4 mt-3">
                                            <form id="editForm_{$product->getId()}" enctype="multipart/form-data">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <div class="label-input-field">
                                                            <label for="edit_name_{$product->getId()}">Nome:</label>
                                                            <input type="text" id="edit_name_{$product->getId()}"
                                                                class="edit-input" value="{$product->getName()}">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="label-input-field">
                                                            <label
                                                                for="edit_description_{$product->getId()}">Descrizione:</label>
                                                            <textarea id="edit_description_{$product->getId()}"
                                                                class="edit-input"
                                                                style="height: 100px; overflow: auto; ">{$product->getDescription()}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="label-input-field">
                                                            <label
                                                                for="edit_ingredients_{$product->getId()}">Ingredienti:</label>
                                                            <input type="text" id="edit_ingredients_{$product->getId()}"
                                                                class="edit-input" value="{$product->getIngredients()}">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="label-input-field">
                                                            <label for="edit_price_{$product->getId()}">Prezzo:</label>
                                                            <input type="text" id="edit_price_{$product->getId()}"
                                                                class="edit-input" value="{$product->getPrice()}€">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="label-input-field">
                                                            <label
                                                                for="edit_category_{$product->getId()}">Categoria:</label>
                                                            <select id="edit_category_{$product->getId()}"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="label-input-field">
                                                            <label
                                                                for="edit_manufacturer_{$product->getId()}">Produttore:</label>
                                                            <select id="edit_manufacturer_{$product->getId()}"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="label-input-field">
                                                            <label for="edit_stock_{$product->getId()}">Quantità in
                                                                magazzino:</label>
                                                            <input type="text" id="edit_stock_{$product->getId()}"
                                                                class="edit-input" value="{$product->getStock()}">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="label-input-field">
                                                            <label
                                                                for="edit_online_{$product->getId()}">Online/Offline:</label>
                                                            <select id="edit_online_{$product->getId()}"
                                                                class="edit-select">
                                                                <option value="0"
                                                                    {if $product->getIsOnline() == 0}selected{/if}>Offline
                                                                </option>
                                                                <option value="1"
                                                                    {if $product->getIsOnline() == 1}selected{/if}>Online
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        ...
                                                        <label for="edit_offer_{$product->getId()}">Offerte:</label>
                                                        <div class="checkbox-container">
                                                            {foreach $data_offers as $offer}
                                                                <div class="checkbox-item">
                                                                    {assign var="isInOffer" value=false}
                                                                    {foreach $product->getOffers() as $offerProduct}
                                                                        {if $offerProduct->getId() == $offer->getId()}
                                                                            {assign var="isInOffer" value=true}
                                                                            {break}
                                                                        {/if}
                                                                    {/foreach}
                                                                    <input type="checkbox" id="edit_offer_{$product->getId()}"
                                                                        name="selected_offers[]" value="{$offer->getId()}"
                                                                        {if $isInOffer}checked{/if}>
                                                                    <label
                                                                        for="offer_{$offer->getId()}">{$offer->getName()}</label>
                                                                </div>
                                                            {/foreach}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="label-input-field">
                                                            <label for="edit_image_{$product->getId()}">Immagine:</label>
                                                            <div id="drop-area">
                                                                <input type="text" id="edit_image_{$product->getId()}"
                                                                    class="edit-input" value="{$product->getImage()}">
                                                                <input type="file" id="fileInput2_{$product->getId()}"
                                                ...
                                                <div class="mt-6 d-flex">
                                                    <button type="button" onclick="saveChanges({$product->getId()})"
                ...
                <ul class="template-pagination d-flex align-items-center mt-6">
                    {for $page = 1 to $total_pages}
                        {if $page == $current_page}
                            <li><a href="adminAccount.php?page={$page}" style=" background-color: #4CAF50;
        color: white; ">{$page}</a></li>
                        {else}
                            <li><a href="adminAccount.php?page={$page}">{$page}</a></li>
                        {/if}
                    {/for}
                    {if $current_page < $total_pages}
                        <li><a href="adminAccount.php?page={$current_page + 1}"><i class="fas fa-arrow-right"></i></a></li>
                    {/if}
                </ul>
            </div>
        </div>
                    ...
                    <tbody>
                        {foreach $data_offers as $offer}
                            <tr>
                                ...
                                <td>
                                    <button type="button" data-bs-toggle="modal"
                                        data-bs-target="#editModalOffer_{$offer->getId()}">
                                        <i class="fa fa-pen" style="color:#4CAF50;"></i>
                                </td>
                                <td>
                            ...
                            <div class="modal fade" id="editModalOffer_{$offer->getId()}" tabindex="-1"
                                aria-labelledby="editModalLabel_{$offer->getId()}" aria-hidden="true">
                                            ...
                                            <div class="gstore-product-quick-view bg-white rounded-3 py-6 px-4">
                                                ...
                                                <div class="row align-items-center g-4 mt-3">
                                                    <form id="editForm3_{$offer->getId()}" enctype="multipart/form-data">
                                                        <input type="text" id="editoffer_name_{$offer->getId()}"
                                                            class="edit-input" value="{$offer->getName()}">
                                                        <input type="date" id="editoffer_startdate_{$offer->getId()}"
                                                            class="edit-input" value="{$offer->getStartDate()}">
                                                        <input type="date" id="editoffer_enddate_{$offer->getId()}"
                                                            class="edit-input" value="{$offer->getEndDate()}">
                                                        <input type="text" id="editoffer_type_{$offer->getId()}"
                                                            class="edit-input" value="{$offer->getType()}">
                                                        <button onclick="saveChangesOffer({$offer->getId()})"
                                                            class="btn btn-primary btn-sm">Salva</button>
                                                    </form>
                                                </div>
                                            </div>
                    ...
                    <tbody>
                        {foreach $categories as $category}
                            <tr class="category">
                                ...
                                <td>
                                    <button type="button" data-bs-toggle="modal"
                                        data-bs-target="#editModalCategory_{$category->getId()}">
                                        <i class="fa fa-pen" style="color:#4CAF50;"></i>
                                    </button>
                                </td>
                                <td>
                            ...
                            <div class="modal fade" id="editModalCategory_{$category->getId()}" tabindex="-1"
                                aria-labelledby="editModalCategory_{$category->getId()}" aria-hidden="true">
                                <!-- Contenuto del modal per modificare un'offerta -->
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <div class="gstore-product-quick-view bg-white rounded-3 py-6 px-4">
                                                ...
                                                <div class="row align-items-center g-4 mt-3">
                                                    <form id="editForm5_{$category->getId()}" enctype="multipart/form-data">
                                                        <input type="text" id="editcategory_name_{$category->getId()}"
                                                            class="edit-input" value="{$category->getName()}">
                                                        <button onclick="saveChangesCategory({$category->getId()})"
                                                            class="btn btn-primary btn-sm">Salva</button>
                                                    </form>
                                                </div>
                                            </div>
                    ...
                    <tbody>
                        {foreach $data_slider as $slider}
                            <tr>
                                ...
                                <td>
                                    <button type="button" data-bs-toggle="modal"
                                        data-bs-target="#editModalSlider_{$slider->getId()}">
                                        <i class="fa fa-pen" style="color:#4CAF50;"></i>
                                    </button>
                                </td>
                                <td>
                            ...
                            <div class="modal fade" id="editModalSlider_{$slider->getId()}" tabindex="-1"
                                aria-labelledby="editModalSlider_{$slider->getId()}" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <button type="button" class="btn-close float-end" data-bs-dismiss="modal"
                                            ...
                                            <div class="gstore-product-quick-view bg-white rounded-3 py-6 px-4">
                                                ...
                                                <div class="row align-items-center g-4 mt-3">
                                                    <form id="editForm2_{$slider->getId()}" enctype="multipart/form-data">
                                                        <input type="text" id="edit_title_{$slider->getId()}"
                                                            class="edit-input " value="{$slider->getTitle()}">
                                                        <input type="text" id="edit_caption_{$slider->getId()}"
                                                            class="edit-input" value="{$slider->getCaption()}">
                                                        <input type="text" id="edit_description_{$slider->getId()}"
                                                            class="edit-input" value="{$slider->getDescription()}">
                                                        <div id="drop-area">
                                                            <input type="text" id="edit_image2_{$slider->getId()}"
                                                                class="edit-input" value="{$slider->getImage()}">
                                                            <input type="file" id="fileInput3_{$slider->getId()}"
                                                                name="image" class="custom-file-input">
                                                        </div>
                                                        <button onclick="saveChangesSlider({$slider->getId()})"
                                                            class="btn btn-primary btn-sm">Salva</button>
                                                    </form>
                                                </div>
                                            </div>
                    ...
                    <tbody>
                        {foreach $manufacturers as $manufacturer}
                            <tr class="manufacturer">
                                ...
                                <td>
                                    <button type="button" data-bs-toggle="modal"
                                        data-bs-target="#editModalManufacturer_{$manufacturer->getId()}">
                                        <i class="fa fa-pen" style="color:#4CAF50;"></i>
                                    </button>
                                </td>
                                ...
                                <td>
                                    <button type="button" onclick="deleteManufacturer({$manufacturer->getId()})">
                                        <i class="fa fa-trash-can" style="color:#FF7C08;"></i>
                                    </button>
                                </td>
                            </tr>
                            <div class="modal fade" id="editModalManufacturer_{$manufacturer->getId()}" tabindex="-1"
                                aria-labelledby="editModalManufacturer_{$manufacturer->getId()}" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <div class="gstore-product-quick-view bg-white rounded-3 py-6 px-4">
                                                ...
                                                <div class="row align-items-center g-4 mt-3">
                                                    <form id="editForm6_{$manufacturer->getId()}"
                                                        enctype="multipart/form-data">
                                                        <input type="text"
                                                            id="editmanufacturer_name_{$manufacturer->getId()}"
                                                            class="edit-input" value="{$manufacturer->getName()}">
                                                        <button onclick="saveChangesManufacturer({$manufacturer->getId()})"
                                                            class="btn btn-primary btn-sm">Salva</button>
                                                    </form>
                                                </div>
                                            </div>
                    ...
                    <tbody>
                        ...
                        {foreach $data_about as $about}
                            <tr>
                                ...
                                <td>
                                    <button type="button" data-bs-toggle="modal"
                                        data-bs-target="#editModalAbout_{$about->getId()}">
                                        <i class="fa fa-pen" style="color:#4CAF50;"></i>
                                    </button>
                                </td>
                            </tr>
                            <!-- Modal Modifica About -->
                            <div class="modal fade" id="editModalAbout_{$about->getId()}" tabindex="-1"
                                aria-labelledby="editModalAbout_{$about->getId()}" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <button type="button" class="btn-close float-end" data-bs-dismiss="modal"
                                                ...
                                                <div class="row align-items-center g-4 mt-3">
                                                    <form id="editForm7_{$about->getId()}" enctype="multipart/form-data">
                                                        <div class="col-sm-6">
                                                            ...
                                                            <textarea id="edit_sloganAbout_{$about->getId()}"
                                                                class="edit-input"
                                                                style="height: 100px; overflow: auto; ">{$about->getSlogan()}</textarea>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label for="edit_titleAbout_{$about->getId()}">Titolo:</label>
                                                            <textarea id="edit_titleAbout_{$about->getId()}"
                                                                class="edit-input"
                                                                style="height: 100px; overflow: auto; ">{$about->getTitle()}</textarea>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="label-input-field">
                                                                <label
                                                                    for="edit_descriptionAbout_{$about->getId()}">Descrizione:</label>
                                                                <textarea id="edit_descriptionAbout_{$about->getId()}"
                                                                    class="edit-input"
                                                                    style="height: 100px; overflow: auto; ">{$about->getDescription()}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label
                                                                for="edit_missionAbout_{$about->getId()}">Missione:</label>
                                                            <textarea id="edit_missionAbout_{$about->getId()}"
                                                                class="edit-input"
                                                                style="height: 100px; overflow: auto; ">{$about->getMission()}</textarea>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label for="edit_visionAbout_{$about->getId()}">Visione:</label>
                                                            <textarea id="edit_visionAbout_{$about->getId()}"
                                                                class="edit-input"
                                                                style="height: 100px; overflow: auto; ">{$about->getVision()}</textarea>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label for="edit_imageAbout_{$about->getId()}">Immagine:</label>
                                                            <div id="drop-area">
                                                                <input type="text" id="edit_imageAbout_{$about->getId()}"
                                                                    class="edit-input" value="{$about->getImage()}">
                                                                <input type="file" id="fileInputAbout_{$about->getId()}"
                                                                    name="image" class="custom-file-input">
                                                            </div>
                                                        </div>
                                                        <button onclick="saveChangesAbout({$about->getId()})"
                                                            class="btn btn-primary btn-sm">Salva</button>
                                                    </form>
                                                </div>
                                            </div>
