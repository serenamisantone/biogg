                                                        ...
                                                        {foreach $products as $product }
                                                            <li class="d-flex align-items-center">
                                                                ...
                                                                <div class="thumb-wrapper">
                                                                    <a href="#"><img
                                                                            src="assets/img/products/{$product->getProduct()->GetImage()}"
                                                                ...
                                                                <div class="items-content ms-3">
                                                                    <a
                                                                        href="singleProduct.php?id={$product->getProduct()->getId()}">
                                                                        <h6 class="mb-1">{$product->getProduct()->GetName()}
                                                                        </h6>
                                                                    </a>
                                                                    <div class="products_meta d-flex align-items-center">
                                                                        <div>
                                                                            <span
                                                                                class="price text-primary fw-semibold">{$product->getProduct()->GetPrice()}€
                                                                            </span>
                                                                            <span class="count">x
                                                                                {$product->getAddedQuantity()}</span>
                                                                        </div>
