<?php
/* Smarty version 4.3.0, created on 2023-07-05 17:19:11
...
use smartyuse smartyuse smartyuse smartyif ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_64a589efbc0487_27232420',
...
function content_64a589efbc0487_27232420 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
<head>
    ...
    <meta name="keywords" content="Bio Green Grocery  ecommerce, admin template, online shop, e-commerce, ecommerce template, marketplace, modern, responsive,  business, mobile, bootstrap, html5, css3, js, gallery, slider, touch, creative, clean">
    <!--favicon icon-->
                                        ...
                                        <div class="cart-box-wrapper">
                                            <div class="apt_cart_box theme-scrollbar">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mt-3">
                                                    ...
                                                    <span class="fw-semibold text-primary">104</span>
                                                </div>
                ...
                <nav class="mobile-menu-wrapper scrollbar">
                    <ul>
                        ...
                        <li>
                            <a href="shop-grid2.html" class="d-flex align-items-center">
                                <div class="me-2 avatar-icon">
                                    <img src="src/assets/img/category/cold-drinks.png" alt="vegetables" class="w-100 h-100 rounded-circle">
                                </div>
