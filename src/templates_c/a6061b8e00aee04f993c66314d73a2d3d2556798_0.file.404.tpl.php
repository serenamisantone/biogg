<?php
/* Smarty version 4.3.0, created on 2023-07-25 12:36:46
  from 'C:\Users\fpall\Desktop\camillabiogg\htdocs\biogg\src\templates\404.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_64bfa5be971710_98537851',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a6061b8e00aee04f993c66314d73a2d3d2556798' => 
    array (
      0 => 'C:\\Users\\fpall\\Desktop\\camillabiogg\\htdocs\\biogg\\src\\templates\\404.tpl',
      1 => 1688820574,
      2 => 'file',
    ),
  ),
...
function content_64bfa5be971710_98537851 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
<head>
    ...
    <!--title-->
    <title>Grostore - 404 - not found - Grostore Grocery eCommerce HTML Template</title>
...
<body>
    ...
    <div class="main-wrapper">
                                ...
                                <div class="category-dropdown position-relative d-none d-md-inline-block">
                                    ...
                                    <div class="category-dropdown-box scrollbar">
                                        <ul class="category-dropdown-menu">
                                            <li>
                                                <a href="shop-grid2.html" class="d-flex align-items-center">
                                ...
                                <nav class="gshop-navmenu ms-3 d-none d-xl-block">
                                    <ul class="d-flex align-itmes-center justify-content-end">
                                        <li class="has-submenu">
                                            ...
                                            <ul>
                                                <li><a href="index.tpl">Home One</a></li>
                                                <li><a href="index-2.html">Home Two</a></li>
                                                <li><a href="index-3.html">Home Three</a></li>
                                            </ul>
                                        </li>
                                        <li class="has-submenu">
                                            <a href="javascript:void(0)">Products<span class="ms-1 fs-xs float-end"><i class="fa-solid fa-angle-down"></i></span></a>
                                            <ul>
                                    ...
                                    <div class="gshop-header-cart position-relative">
                                        ...
                                        <div class="cart-box-wrapper">
                                            <div class="apt_cart_box theme-scrollbar">
                                                    ...
                                                    <li class="d-flex align-items-center">
                                                        ...
                                                        <div class="items-content ms-3">
                                                            ...
                                                            <div class="products_meta d-flex align-items-center">
                                                                ...
                                                                <button class="remove_cart_btn"><i class="fa-solid fa-trash-can"></i></button>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="d-flex align-items-center">
                                                ...
                                                <a href="checkout.html" class="btn btn-primary btn-md d-block mt-4"><span class="me-2"><i class="fa-solid fa-wallet"></i></span>Checkout</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="section-404 ptb-120 position-relative overflow-hidden z-1">
            <img src="assets/img/shapes/frame-circle.svg" alt="frame circle" class="position-absolute z--1 frame-circle d-none d-sm-block">
            <img src="assets/img/shapes/cauliflower.png" alt="cauliflower" class="position-absolute cauliflower z--1 d-none d-sm-block">
            <img src="assets/img/shapes/leaf.svg" alt="leaf" class="position-absolute leaf z--1 d-none d-sm-block">
            <img src="assets/img/shapes/pata-xs.svg" alt="pata" class="position-absolute pata z--1 d-none d-sm-block">
            <img src="assets/img/shapes/tomato-half.svg" alt="tomato" class="position-absolute tomato-half z--1 d-none d-sm-block">
            <img src="assets/img/shapes/garlic-white.png" alt="garlic" class="position-absolute garlic-white z--1 d-none d-sm-block">
            <img src="assets/img/shapes/tomato-slice.svg" alt="tomato" class="position-absolute tomato-slice z--1 d-none d-sm-block">
            <img src="assets/img/shapes/onion.png" alt="tomato" class="position-absolute onion z--1 d-none d-sm-block">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="content-404 text-center">
                            <img src="assets/img/404.png" alt="not found" class="img-fluid">
                            ...
                            <a href="#" class="btn btn-secondary btn-md rounded-1">Back to Home Page</a>
                        </div>
                    </div>
                </div>
            </div>
