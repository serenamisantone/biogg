...
function content_6509a0460a7c35_52125019 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
<head>
    ...
    <!--meta-->
    <meta name="description" content="Bio Green Grocery">
    <meta name="author" content="ThemeTags">
    <meta name="keywords"
        content="Bio Green Grocery  ecommerce, admin template, online shop, e-commerce, ecommerce template, marketplace, modern, responsive,  business, mobile, bootstrap, html5, css3, js, gallery, slider, touch, creative, clean">
    <!--favicon icon-->
    <link rel="icon" href="assets/img/favicon.png" type="image/png" sizes="16x16">

    <!--title-->
    <title>Bio Green Grocery</title>
                        ...
                        <div class="col-xxl-10 col-xl-9 col-md-9 col-7">
                            <div class="gshop-navbar-right d-flex align-items-center justify-content-end position-relative"
                                ...
                                <div class="category-dropdown position-relative d-none d-md-inline-block">
                                    <a href="home.php"
                                        class="category-dropdown-btn fw-bold d-none d-sm-inline-block">Home</a>
                                </div>
                                    ...
                                    <svg width="18" height="25" viewBox="0 0 22 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="user-menu-wrapper">
                                            <ul class="user-menu">
                                                ...
                                                <li><a href="logout.php"><span class="me-2"><i
                                                ...
                                                <div class="apt_cart_box theme-scrollbar">
                                                 <?php if (((isset($_smarty_tpl->tpl_vars['cart']->value)))) {?>
                                                    <ul class="at_scrollbar scrollbar">
                                                        <?php $_smarty_tpl->_assignInScope('products', $_smarty_tpl->tpl_vars['cart']->value->getProducts());?>
...
?>
                                                            <li class="d-flex align-items-center">
                                                                ...
                                                                <div class="thumb-wrapper">
                                                                    <a href="#"><img
                                                                            src="assets/img/products/<?php echo $_smarty_tpl->tpl_vars['product']->value->getProduct()->GetImage();?>
"
                                                                ...
                                                                <div class="items-content ms-3">
                                                                    <a
                                                                        href="singleProduct.php?id=<?php echo $_smarty_tpl->tpl_vars['product']->value->getProduct()->getId();?>
">
                                                                        <h6 class="mb-1"><?php echo $_smarty_tpl->tpl_vars['product']->value->getProduct()->GetName();?>
                                                                    ...
                                                                    <div class="products_meta d-flex align-items-center">
                                                                        <div>
                                                                            <span
                                                                                class="price text-primary fw-semibold"><?php echo $_smarty_tpl->tpl_vars['product']->value->getProduct()->GetPrice();?>
€
                                                                            </span>
                                                                            <span class="count">x
                                                                                <?php echo $_smarty_tpl->tpl_vars['product']->value->getAddedQuantity();?>
</span>
                                                                        </div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                            ...
                                            <span class="fw-semibold text-primary"> <?php if (((isset($_smarty_tpl->tpl_vars['cart']->value)))) {
echo $_smarty_tpl->tpl_vars['cart']->value->getTotalPrice();?>
 <?php } else { ?> 0 <?php }?>€</span>
                                                    </div>
