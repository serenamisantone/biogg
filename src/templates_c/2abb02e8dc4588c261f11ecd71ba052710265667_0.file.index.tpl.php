...
function content_64d5569b6cf5e4_48036578 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
                        ...
                        <div class="col-xxl-10 col-xl-9 col-md-9 col-7">
                            <div class="gshop-navbar-right d-flex align-items-center justify-content-end position-relative" style="margin-right: 10%">
                                <div class="category-dropdown position-relative d-none d-md-inline-block">
                                    <a href="home.php" class="category-dropdown-btn fw-bold d-none d-sm-inline-block">Home</a>                                                                       
                                </div>
                                ...
                                <div class="user-menu-wrapper">
                                    <ul class="user-menu">
                                        ...
                                        <li><a href="wishlist.php"><span class="me-2"><i class="fa-solid fa-heart"></i></span>My Wishlist</a></li>
